...
- Analisis comercial (frio/caliente, cierre, objeciones)
- Base de conocimiento (TXT/DOCX/XLSX)
- OpenAI real (si OPENAI_API_KEY esta configurada)
"""
...
# =====================================================
# Memoria de sesion y conocimiento
# =====================================================
...
# =====================================================
# Analizador principal de contexto comercial
# =====================================================
...
@app.post("/api/chat")
def api_chat() -> Any:
    """Endpoint OpenAI real. Usa memoria + contexto comercial completo."""
    payload = request.get_json(force=True) or {}
...
def api_upload_info() -> Any:
    if "file" not in request.files:
        return jsonify({"ok": False, "error": "Falta archivo en campo file"}), 400
...
if __name__ == "__main__":
    print("CityCred Cerebro Hibrido listo")
